...
export default function DashboardLayout({
  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed lg:static inset-y-0 left-0 z-30 w-64 bg-surface border-r border-border flex flex-col transform transition-transform duration-200 ${
      ...
      >
        ...
        <div className="px-6 py-5 border-b border-border flex items-center justify-between">
          ...
          <button
            onClick={() => setSidebarOpen(false)}
            className="lg:hidden text-secondary hover:text-text"
          >
        ...
        <div className="px-4 py-4 border-t border-border">
          <Link
            href="/checkout"
            className="flex items-center gap-2 px-3 py-2.5 bg-accent text-white rounded-xl text-sm font-semibold hover:opacity-90 transition-opacity"
          >
            <span>🔥</span>
            New deployment
          </Link>
          ...
          <div className="flex items-center gap-4 ml-auto">
            <div className="flex items-center gap-3">
              ...
              <div className="hidden sm:block">
                <div className="text-sm font-medium text-text">Tyler</div>
