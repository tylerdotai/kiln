...
const PLANS = [
  {
    ...
    price: "Free",
    desc: "Try it out.",
    features: ["1 AI agent", "Discord or Telegram", "GPT-3.5 (fast, free)", "100 messages per day", "Community support"],
    cta: "Start free",
    highlight: false,
  },
  {
    ...
    period: "/mo",
    desc: "Daily use.",
    features: ["1 AI agent", "Both Discord and Telegram", "GPT-4o, Claude, Gemini", "Unlimited messages", "Priority support"],
    cta: "Go Pro",
    highlight: true,
  },
  {
    ...
    features: ["5 AI agents", "Both Discord and Telegram", "All models included", "Unlimited messages", "Dedicated support"],
    cta: "Contact us",
    highlight: false,
  },
];
